...
export function icon(name, size = 18) {
  const icons = {
    ...
    diamond: '<path d="M19 3H5L2 9l10 12L22 9l-3-6zm-1.18 5h-3.09l1.57-3.14L17.82 8zm-8.36-3h5.08l-1.57 3.14h-1.89L9.46 5zM6.18 8l1.52-3.04L9.27 8H6.18zM12 17.92L6.62 10h10.76L12 17.92z"/>',
    route: '<path d="M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zM9.8 8.9L7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-3C14.8 12 16.8 13 19 13v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.56-.89-1.68-1.25-2.65-.84L7 8.3V13h2V9.6l.8-.7"/>',
    ...
    outbox: '<path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8l8 5 8-5v10zm-8-7L4 6h16l-8 5z"/>',
